...
public sealed class RepairOrderRepository
{
    ...
    public async Task<(List<RepairOrder> Items, System.Int32 TotalCount)> GetPageAsync(
        RepairOrderListQuery query)
    {
        ...
        {
            System.String term = query.SearchTerm.Trim();
            if (System.Int32.TryParse(term, out System.Int32 id))
            {
    ...
    public Task<RepairOrder> GetByIdAsync(System.Int32 id)
    {
