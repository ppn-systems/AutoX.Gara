...
public sealed class EmployeeRepository(AutoXDbContext context) : IEmployeeRepository
{
    ...
    {
        IQueryable<Employee> q = _context.Employees.AsNoTracking().Where(e => e.DeletedAt == null);
        // -- Search ---------------------------------------------------------
    ...
    public System.Threading.Tasks.Task<bool> ExistsByEmailAsync(
        string email,
        System.Threading.CancellationToken ct = default)
        => _context.Employees.AnyAsync(e => e.DeletedAt == null && e.Email == email, ct);
    public System.Threading.Tasks.Task<bool> ExistsByPhoneAsync(
        string phone,
        System.Threading.CancellationToken ct = default)
        => _context.Employees.AnyAsync(e => e.DeletedAt == null && e.PhoneNumber == phone, ct);
    // --- Write ----------------------------------------------------------------
    ...
    {
        employee.DeletedAt = System.DateTime.UtcNow;
        _context.Employees.Update(employee);
    }
