...
public sealed class ServiceItemRepository : IServiceItemRepository
{
    ...
    public async Task<(List<ServiceItem> Items, System.Int32 TotalCount)> GetPageAsync(ServiceItemListQuery query)
    {
    ...
    public Task<ServiceItem> GetByIdAsync(System.Int32 id)
