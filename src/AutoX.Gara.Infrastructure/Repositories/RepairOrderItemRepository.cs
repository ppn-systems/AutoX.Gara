...
public sealed class RepairOrderItemRepository : IRepairOrderItemRepository
{
    ...
    public async Task<(List<RepairOrderItem> Items, System.Int32 TotalCount)> GetPageAsync(RepairOrderItemListQuery query)
    {
    ...
    public Task<RepairOrderItem> GetByIdAsync(System.Int32 id)
