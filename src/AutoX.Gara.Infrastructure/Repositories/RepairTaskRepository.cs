...
public sealed class RepairTaskRepository : IRepairTaskRepository
{
    ...
    public async Task<(List<RepairTask> Items, System.Int32 TotalCount)> GetPageAsync(RepairTaskListQuery query)
    {
    ...
    public Task<RepairTask> GetByIdAsync(System.Int32 id)
