...
public enum ServiceType : byte
{
    ...
    [Display(Name = "S?a ch?a hệ thống phanh")]
    BrakeRepair = 13,
    [Display(Name = "S?a ch?a hệ thống l�i & treo")]
    SuspensionRepair = 14,
    [Display(Name = "S?a ch?a hệ thống nhi�n li?u")]
    FuelSystemRepair = 15,
    [Display(Name = "D?ch v? di?n & ?c quy")]
    ElectricalService = 16,
    [Display(Name = "S?a ch?a hệ thống d�nh l?a")]
    IgnitionRepair = 17,
    // ?? **L�m d?p & ph?c h?i xe**
    ...
    [Display(Name = "L?p d?t & s?a ch?a hệ thống c?m bi?n h? tr? l�i")]
