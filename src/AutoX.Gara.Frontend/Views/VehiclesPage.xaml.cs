...
/// CustomerDataPacket du?c truy?n qua <see cref="Initialize"/> t? CustomersPage
...

{
...

    {
        ...
        await PickerActionSheetHelper.ShowAsync(sender as VisualElement, "H�ng xe", vm.FormBrandOptions, idx => vm.FormPickerBrandIndex = idx);
...

    {
        ...
        await PickerActionSheetHelper.ShowAsync(sender as VisualElement, "Lo?i xe", vm.FormTypeOptions, idx => vm.FormPickerTypeIndex = idx);
...

    {
        ...
        await PickerActionSheetHelper.ShowAsync(sender as VisualElement, "M�u s?c", vm.FormColorOptions, idx => vm.FormPickerColorIndex = idx);
