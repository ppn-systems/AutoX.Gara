...

{
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "Ch?n lo?i ph? t�ng", vm.PartCategoryFilterOptions, idx => vm.PickerCategoryIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("Ch?n lo?i ph? t�ng", "H?y", null, opts);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "Lo?i ph? t�ng", vm.PartCategoryFormOptions, idx => vm.FormPickerCategoryIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("Lo?i ph? t�ng", "H?y", null, opts);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "T?n kho", vm.InStockFilterOptions, idx => vm.PickerInStockIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("T?n kho", "H?y", null, vm.InStockFilterOptions);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "T�nh tr?ng", vm.DefectiveFilterOptions, idx => vm.PickerDefectiveIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("T�nh tr?ng", "H?y", null, vm.DefectiveFilterOptions);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "H?n sử dụng", vm.ExpiredFilterOptions, idx => vm.PickerExpiredIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("H?n sử dụng", "H?y", null, vm.ExpiredFilterOptions);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "Tr?ng th�i b�n", vm.DiscontinuedFilterOptions, idx => vm.PickerDiscontinuedIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("Tr?ng th�i b�n", "H?y", null, vm.DiscontinuedFilterOptions);
