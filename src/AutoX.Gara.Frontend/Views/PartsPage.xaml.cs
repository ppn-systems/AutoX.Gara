...

{
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "H?n s? d?ng", vm.ExpiredFilterOptions, idx => vm.PickerExpiredIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("H?n s? d?ng", "H?y", null, vm.ExpiredFilterOptions);
