...
public partial class PartsPage : ContentPage
{
    ...
    private async void OnCategoryFilterTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFilterCategoryText, vm.PartCategoryFilterOptions, idx => vm.PickerCategoryIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFilterCategoryText, UiTextConfiguration.Current.CommonActionCancelText, null, opts);
    ...
    private async void OnFormCategoryTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFormCategoryText, vm.PartCategoryFormOptions, idx => vm.FormPickerCategoryIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFormCategoryText, UiTextConfiguration.Current.CommonActionCancelText, null, opts);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
    ...
    private async void OnInStockFilterTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFilterStockText, vm.InStockFilterOptions, idx => vm.PickerInStockIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFilterStockText, UiTextConfiguration.Current.CommonActionCancelText, null, vm.InStockFilterOptions);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
    ...
    private async void OnDefectiveFilterTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFilterConditionText, vm.DefectiveFilterOptions, idx => vm.PickerDefectiveIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFilterConditionText, UiTextConfiguration.Current.CommonActionCancelText, null, vm.DefectiveFilterOptions);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
    ...
    private async void OnExpiredFilterTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFilterExpiryText, vm.ExpiredFilterOptions, idx => vm.PickerExpiredIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFilterExpiryText, UiTextConfiguration.Current.CommonActionCancelText, null, vm.ExpiredFilterOptions);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
    ...
    private async void OnDiscontinuedFilterTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.PartsPickerFilterSaleStatusText, vm.DiscontinuedFilterOptions, idx => vm.PickerDiscontinuedIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.PartsPickerFilterSaleStatusText, UiTextConfiguration.Current.CommonActionCancelText, null, vm.DiscontinuedFilterOptions);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
