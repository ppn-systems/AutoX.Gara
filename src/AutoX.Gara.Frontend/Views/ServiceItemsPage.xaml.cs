...

{
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "Ch?n lo?i d?ch v?", vm.ServiceTypeFilterOptions, idx => vm.PickerTypeIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("Ch?n lo?i d?ch v?", "H?y", null, options);
...

    {
        ...
        if (TryShowFlyout(sender as VisualElement, "Lo?i d?ch v?", vm.ServiceTypeFormOptions, idx => vm.FormTypeIndex = idx))
        ...
        String pick = await page.DisplayActionSheetAsync("Lo?i d?ch v?", "H?y", null, options);
