...
public sealed partial class SuppliersPage : ContentPage
{
    ...
    private async void OnFilterStatusTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.SuppliersPickerFilterStatusText, vm.FilterStatusOptions, idx => vm.PickerStatusIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.SuppliersPickerFilterStatusText, UiTextConfiguration.Current.CommonActionCancelText, null, options);
    ...
    private async void OnFilterPaymentTermsTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.SuppliersPickerFilterPaymentTermsText, vm.FilterPaymentTermsOptions, idx => vm.PickerPaymentTermsIndex = idx))
        {
            return;
        }
#endif
        ...
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.SuppliersPickerFilterPaymentTermsText, UiTextConfiguration.Current.CommonActionCancelText, null, options);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.SuppliersPickerFormStatusText, vm.FormStatusOptions, idx => vm.FormStatusIndex = idx))
        {
            return;
        }
#endif
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.SuppliersPickerFormPaymentTermsText, vm.FormPaymentTermsOptions, idx => vm.FormPaymentTermsIndex = idx))
        {
            return;
        }
#endif
    ...
    private async void OnNewStatusTapped(Object? sender, TappedEventArgs e)
    {
...
#if WINDOWS
        if (TryShowFlyout(sender as VisualElement, UiTextConfiguration.Current.SuppliersPickerChangeStatusText, vm.FormStatusOptions, idx => vm.NewStatusIndex = idx))
        {
            return;
        }
#endif
        ...
        String[] options = vm.FormStatusOptions.ToArray();
        String pick = await page.DisplayActionSheetAsync(UiTextConfiguration.Current.SuppliersPickerChangeStatusText, UiTextConfiguration.Current.CommonActionCancelText, null, options);
        if (pick == UiTextConfiguration.Current.CommonActionCancelText || String.IsNullOrWhiteSpace(pick))
        {
            return;
        }
