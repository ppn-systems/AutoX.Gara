...
public static class EnumText
{
    public static string Get<TEnum>(TEnum value) where TEnum : struct, System.Enum
    {
        ...
        return desc is not null && !string.IsNullOrWhiteSpace(desc.Description) ? desc.Description : value.ToString();
    }
    public static string[] GetNames<TEnum>() where TEnum : struct, System.Enum => [.. System.Enum.GetValues<TEnum>().Select(Get)];
}
