...

{
...

    {
        ...
        { SetFormError("T�n nh� cung c?p kh�ng du?c d? tr?ng."); return false; }

        if (FormName.Length > 150)

        { SetFormError("T�n kh�ng du?c vu?t qu� 150 k� t?."); return false; }
        ...
        { SetFormError("M� s? thu? kh�ng du?c d? tr?ng."); return false; }
