...
public sealed partial class InvoicesViewModel : ObservableObject, System.IDisposable
{
    ...
    public sealed partial class InvoiceRow : ObservableObject
    {
        ...
        public string PayNowText => CanPay
            ? UiTextConfiguration.Current.InvoicesActionPayNowText
            : UiTextConfiguration.Current.InvoicesActionPaidText;
    ...
    public string PageTitle => Owner is null
        ? UiTextConfiguration.Current.InvoicesPageTitleText
        : string.Format(System.Globalization.CultureInfo.CurrentCulture, UiTextConfiguration.Current.InvoicesPageTitleWithOwnerText, Owner.Name);
    ...
    public async System.Threading.Tasks.Task LoadAsync()
    {
        ...
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.InvoicesErrorLoadFailedText,
    ...
    private async System.Threading.Tasks.Task SaveAsync()
    {
        ...
        {
            HasError = true;
            ErrorMessage = UiTextConfiguration.Current.InvoicesValidationInvoiceNumberRequiredText;
            return;
        }
        IsLoading = true;
        ClearError();
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.InvoicesErrorSaveFailedText,
                    result.ErrorMessage ?? UiTextConfiguration.Current.CommonErrorActionFailedText,
                    result.Advice);
                return;
            }
    ...
    private async System.Threading.Tasks.Task OpenTransactionsAsync(InvoiceRow row)
    {
        ...
        catch (Exception ex)
        {
            LogException(ex);
            HandleError(
                UiTextConfiguration.Current.InvoicesErrorOpenTransactionsFailedText,
                UiTextConfiguration.Current.CommonErrorTryAgainText,
    ...
    private async System.Threading.Tasks.Task PayNowAsync(InvoiceRow row)
    {
        ...
        catch (Exception ex)
        {
            LogException(ex);
            HandleError(
                UiTextConfiguration.Current.InvoicesErrorPayNowFailedText,
                UiTextConfiguration.Current.CommonErrorTryAgainText,
                ProtocolAdvice.BACKOFF_RETRY);
        }
    }
    ...
    private async System.Threading.Tasks.Task DeleteInternalAsync(InvoiceRow row)
    {
        ...
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.InvoicesErrorDeleteFailedText,
                    result.ErrorMessage ?? UiTextConfiguration.Current.CommonErrorActionFailedText,
                    result.Advice);
                return;
            }
    ...
    private async System.Threading.Tasks.Task ToggleDetails(InvoiceRow row)
    {
        ...
        if (roId <= 0)
        {
            MoneyPopupLineItemsError = UiTextConfiguration.Current.InvoicesMoneyPopupErrorLinkedOrderMissingText;
            return;
        }
    ...
    private async System.Threading.Tasks.Task LoadMoneyPopupLineItemsAsync(int repairOrderId, System.Threading.CancellationToken ct)
    {
        ...
        try
        {
            ...
            for (int page = 1; ; page++)
            {
                ...
                if (!res.IsSuccess)
                {
                    MoneyPopupLineItemsError = res.ErrorMessage
                        ?? UiTextConfiguration.Current.InvoicesMoneyPopupErrorLoadServiceLinesFailedText;
                    return;
                }
            ...
            for (int page = 1; ; page++)
            {
                ...
                {
                    MoneyPopupLineItemsError = res.ErrorMessage
                        ?? UiTextConfiguration.Current.InvoicesMoneyPopupErrorLoadPartLinesFailedText;
                    return;
                }
            ...
            foreach (var grp in tasks.GroupBy(t => t.ServiceItemId).OrderBy(g => g.Key))
            {
                ...
                string fallbackTitle = string.Format(System.Globalization.CultureInfo.CurrentCulture, UiTextConfiguration.Current.InvoicesMoneyPopupServiceFallbackText, id);
            ...
            foreach (var grp in items.GroupBy(i => i.PartId).OrderBy(g => g.Key))
            {
                ...
                string fallbackTitle = string.Format(System.Globalization.CultureInfo.CurrentCulture, UiTextConfiguration.Current.InvoicesMoneyPopupPartFallbackText, id);
        ...
        {
            LogException(ex);
            MoneyPopupLineItemsError = UiTextConfiguration.Current.InvoicesMoneyPopupErrorLoadLineDetailsFailedText;
        }
        finally
        {
