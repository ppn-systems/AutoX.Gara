...
public sealed partial class RepairTasksViewModel : ObservableObject, System.IDisposable
{
    ...
    public string PageTitle => RepairOrder?.RepairOrderId is null
        ? UiTextConfiguration.Current.RepairTasksPageTitleText
        : string.Format(System.Globalization.CultureInfo.CurrentCulture, UiTextConfiguration.Current.RepairTasksPageTitleWithIdText, RepairOrder.RepairOrderId);
    ...
    public string FormTitle => IsEditing
        ? UiTextConfiguration.Current.RepairTasksFormTitleEditText
        : UiTextConfiguration.Current.RepairTasksFormTitleCreateText;
    ...
    public async System.Threading.Tasks.Task LoadAsync()
    {
        ...
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.RepairTasksErrorLoadFailedText,
    ...
    private async System.Threading.Tasks.Task SaveAsync()
    {
        ...
        {
            HasError = true;
            ErrorMessage = UiTextConfiguration.Current.RepairTasksValidationEmployeeAndServiceRequiredText;
            return;
        }
        IsLoading = true;
        ClearError();
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.RepairTasksErrorSaveFailedText,
                    result.ErrorMessage ?? UiTextConfiguration.Current.CommonErrorActionFailedText,
                    result.Advice);
                return;
            }
    ...
    private async System.Threading.Tasks.Task ConfirmDeleteAsync()
    {
        ...
        try
        {
            ...
            {
                HandleError(
                    UiTextConfiguration.Current.RepairTasksErrorDeleteFailedText,
                    result.ErrorMessage ?? UiTextConfiguration.Current.CommonErrorActionFailedText,
                    result.Advice);
                return;
            }
