...

{
    ...
    public string PageTitle => RepairOrder?.RepairOrderId is null
        ...
        : $"Part l?nh #{RepairOrder.RepairOrderId}";
...

    {
...

        {
...

            {
                ...
                ErrorMessage = $"Kh�ng t?i được danh s�ch part: {result.ErrorMessage ?? "Thao t�c th?t b?i."}";
...

        {
            ...
            ErrorMessage = $"Kh�ng t?i được danh s�ch part: {ex.Message}";
...

    {
...

        {
...

            {
                ...
                ErrorMessage = result.ErrorMessage ?? "Thao t�c th?t b?i.";
...

    {
...

        {
            ...
            ErrorMessage = "Vui l�ng ch?n Part v� nh?p Quantity > 0.";
