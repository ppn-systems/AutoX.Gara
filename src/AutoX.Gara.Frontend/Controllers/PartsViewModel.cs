...
public sealed partial class PartsViewModel : ObservableObject, System.IDisposable
{
    ...
    public System.String[] InStockFilterOptions { get; } = ["Tất cả", "Còn hàng", "H?t hàng"];
    public System.String[] DefectiveFilterOptions { get; } = ["Tất cả", "Bình thuờng", "Bị lỗi"];
    public System.String[] ExpiredFilterOptions { get; } = ["Tất cả", "Còn hàng", "Hết hàng"];
    public System.String[] DiscontinuedFilterOptions { get; } = ["Tất cả", "Ðang bán", "Ngừng bán"];
    ...
    public System.String FormSaveText => IsEditing ? "Luu thay đổi" : "Thêm phụ tùng";
    ...
    private System.Boolean ValidateForm()
    {
        ...
        if (!IsEditing)
        {
            ...
            { SetFormError("Mã SKU Tải da 12 ký t?, ch? g?m ch? và s?."); return false; }
        }

        if (System.String.IsNullOrWhiteSpace(FormPartName))
        { SetFormError("Tên phụ tùng không du?c d? tr?ng."); return false; }
        ...
        { SetFormError("S? lu?ng phụi là s? nguyên không âm."); return false; }
        ...
        { SetFormError("Ngày h?t h?n phụi sau ngày nh?p kho."); return false; }
