...
public sealed partial class RepairTasksViewModel : ObservableObject, System.IDisposable
{
    ...
    public sealed class RepairTaskRow
    {
        ...
        public System.String EmployeeName { get; init; } = System.String.Empty;
        public System.String ServiceDescription { get; init; } = System.String.Empty;
    }
    ...
    [ObservableProperty] public partial System.DateTime FormStartDateValue { get; set; } = System.DateTime.Today;
    ...
    private void RefreshRowDisplays()
    {
        ...
        for (System.Int32 i = 0; i < _rawTasks.Count; i++)
        {
            RepairTaskDto t = _rawTasks[i];
            _employeeNameById.TryGetValue(t.EmployeeId, out System.String? empName);
            _serviceDescById.TryGetValue(t.ServiceItemId, out System.String? svcDesc);
    ...
    private void RefreshEmployeeFilter()
    {
        ...
        System.String term = EmployeeSearchTerm?.Trim() ?? System.String.Empty;
        for (System.Int32 i = 0; i < EmployeeOptions.Count; i++)
        {
    ...
    private void RefreshServiceItemFilter()
    {
        ...
        System.String term = ServiceItemSearchTerm?.Trim() ?? System.String.Empty;
        for (System.Int32 i = 0; i < ServiceItemOptions.Count; i++)
        {
    ...
    public async System.Threading.Tasks.Task LoadAsync()
    {
        ...
        try
        {
            ...
            if (!result.IsSuccess)
            {
                HandleError("Không tải được task", result.ErrorMessage ?? "Thao tác thất bại.", result.Advice);
                return;
            }
    ...
    private void OpenEditForm(RepairTaskDto t)
    {
        ...
        FormCompletionDateValue = t.CompletionDate?.ToLocalTime().Date ?? System.DateTime.Today;
        IsFormVisible = true;
    }
    ...
    private async System.Threading.Tasks.Task SaveAsync()
    {
        ...
        {
            HasError = true;
            ErrorMessage = "Vui lòng chọn Nhân viên và Dịch vụ.";
            return;
        }
