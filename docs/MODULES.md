...
> Từng **module chức năng**: entity, màn hình client, handler server (Ops), mục đích.
...
Chi tiết entity và quan hệ: [DATABASE.md](DATABASE.md). Giao thức request/response: [PROTOCOL.md](PROTOCOL.md).
